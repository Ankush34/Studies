...
public class Buy_final_activity extends AppCompatActivity {
    ...
    private EditText finance_down_payment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        finance_down_payment = (EditText) findViewById(R.id.finance_down_payment);
            ...
            public void onClick(View view) {
                ...
                for (int i = 0; i < views_visible.size(); i++) {
                    ...
                    if (v.getId() == R.id.payment_mode_finance) {
                        ...
                        if(finance_down_payment.getText().toString().equals(""))
                        {
                            finance_down_payment.setError("Enter down payment amount");
                            entries_required = true;
                        }
                        ...
                        if (!finance_amount.getText().toString().equals("")) {
                            ...
                            total_amount = total_amount + Integer.parseInt(finance_down_payment.getText().toString());
                            Log.d("ViewVisible", "Finance ID: " + v.getId());
                            upload_payment_details("Finance");
                            int payment_by_finance = Integer.parseInt(finance_amount.getText().toString()) + Integer.parseInt(finance_down_payment.getText().toString());
                ...
                if (total_amount == total_price_of_products) {
                    ...
                    total_amount_confirm.setText(total_price_of_products+" /-");
                } else {
                    Toast.makeText(getApplicationContext(), "Can place order succesfully With " + (total_price_of_products - total_amount) + " Cash Payment", Toast.LENGTH_LONG).show();
                    partial_cash_payment = true;
                    cash_payment = total_price_of_products - total_amount;
    ...
    public void update_payment_card(int payment_amount) {
        TextView text1 = (TextView) findViewById(R.id.text1);
        text1.setText("Payment Amount  " + (Math.round(payment_amount / 1.12)) + " /-");

        TextView text2 = (TextView) findViewById(R.id.text2);
        text2.setText("Discount  " + getIntent().getExtras().getInt("discount_applicable") + " /-");

        TextView text3 = (TextView) findViewById(R.id.text3);
        text3.setText("Taxable Amount   " + Math.round(payment_amount - (payment_amount / 1.12)) + " /-");
    ...
    public void set_baught() {
        ...
        JsonArrayRequest bought_req = new JsonArrayRequest((AppConfig.url_set_bought + appConfig.getUser_email()+"&date="+formattedDate),
    ...
    public void upload_payment_details(final String payment_mode) {
        ...
        if (payment_mode.equals("Finance")) {
            ...
            params.put("down_payment_amount", finance_down_payment.getText().toString());
        }
