...
public class FoldingCellListAdapter extends ArrayAdapter<Product> {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.price.setText(""+item.getPrice_mrp());
      ...
      // viewHolder.toAddress.setText(item.getToAddress());
        ...
        viewHolder.pledgePrice.setText(""+(item.get_Stock()*item.getPrice_mrp()));
        viewHolder.total.setText(""+(item.get_Stock()*item.getPrice_mrp()));
        viewHolder.fromAddress.setText(item.get_Name());
        viewHolder.paid.setText(""+(item.get_Stock()*item.getPrice_ks()));
        viewHolder.paid1.setText(""+(item.get_Stock()*item.getPrice_ks()));
        viewHolder.price1.setText(""+(item.get_Stock()*item.getPrice_mrp()));
