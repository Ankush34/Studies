 ...
 * @author amura
 */
public class khurana_final extends Application {
    ...
    private HBox Item(int index, String text)    
    {
        ...
        paneIndicator.setPrefSize(5, 20);
...
"    -fx-text-fill: WHITE;");
        ...
        inner_grid.add(Card("Generate Reports",14,"blue" ), 0, 0);
        inner_grid.add(Card("Manage Accounts",13,"#039BE5"), 1, 0);
        inner_grid.add(Card("Perform Operations",12,"#F06292" ), 0, 1);
        inner_grid.add(Card("Generate Notes",15,"#4DD0E1"), 1, 1);
