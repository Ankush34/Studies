...
public class Product_Stock extends Application {
	 ...
	 private VBox sidePane()
	    ...
	    public TableView<StockItem> get_stock_table()
	    {
	    	TableView<StockItem> tableView = new TableView<>();
             ...
             TableColumn columnBrand = new TableColumn("Brand");
             columnBrand.setCellValueFactory(
                     new PropertyValueFactory<StockItem,String>("Brand"));
             
             columnBrand.setCellFactory(cellFactory);
             columnBrand.setOnEditCommit(
             ...
             tableView.getColumns().addAll(columnName, columnBrand);
	    ...
	    public TableView<OrderDetail> get_order_table()
	    {
	    	TableView<OrderDetail> tableView = new TableView<>();
             ...
             columnName.setMinWidth(300);
             TableColumn columnBrand = new TableColumn("Order Number");
             columnBrand.setCellValueFactory(
	...
	public void start(Stage stage) throws Exception {
		// TODO Auto-generated method stub
			...
			main_view.getChildren().add(sidePane());
	        main_view.setPrefSize(1500, 1000);
	        BorderPane borderPane = new BorderPane();
	        borderPane.setPrefSize(800, 500);
	       
	        BorderPane border_pane_main =  new BorderPane();
	        border_pane_main.setPrefSize(1200, 1000);
	        ...
	        borderPane.setMargin(search_box_container, new Insets(10,155,0,23));
	        ...
	        borderPaneLower.setPrefSize(800, 500);
	...
	public  void send_http_request_orders()
	{
		try {
			System.out.println("");
			String url ="http://khuranasales.co.in/work/get_bought.php?email=khuranasales2015@gmail.com&order_date=26-06-2018";
		     URL obj = new URL(url);
		     ...
		     {	 JSONObject object = array.getJSONObject(i);
		    	 dataListOrders.add(new OrderDetail(object.getString("name"),object.getString("sales_order_number")));
		     }
	...
	public  void send_http_request()
	{
		try {
			...
			String url ="http://khuranasales.co.in/work/get_products.php?brand=Samsung";
		     ...
		     {
		    	 JSONObject object = array.getJSONObject(i);
		    	 dataList.add(new StockItem(object.getString("Name"),""));
