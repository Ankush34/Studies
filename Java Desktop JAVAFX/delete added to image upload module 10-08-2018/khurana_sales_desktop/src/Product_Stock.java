        ...
        btn_upload.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent event) {
                 ...
                 if (file != null) {
                     ...
                     String timeStamp = new SimpleDateFormat("yyyy.MM.dd.HH.mm.ss").format(new Date());
                     UploadProductPojo pro = new UploadProductPojo(file.getAbsolutePath(),product_name,timeStamp,"Pending",false);
                         ...
                         setText(null);
                            ...
                            btn.setStyle("-fx-background-color: #3d5afe;\n" + 
                         	...
                         	btn.setOnAction(event -> {
                        	 	...
                        	 	String[] links = item1.getImage_urls().split(",");
                        	 	uploaded_products_list.clear();
                        	 	if(links.length > 0 && links[0] != "")
                        	 	{
                        	 		for(int i = 0 ; i <links.length; i++)
                        	 		{
                        	 		   String timeStamp = new SimpleDateFormat("yyyy.MM.dd.HH.mm.ss").format(new Date());
                                       UploadProductPojo pro = new UploadProductPojo(links[i],item1.getName(),timeStamp,"Pending",true);
                                       uploaded_products_list.add(pro);
	...
	public void search_products(String search_string)
	{
		try {
			...
			String url ="http://khuranasales.co.in/work/get_searched_products_desktop.php?search="+search_string;
		     ...
		     {
		    	 JSONObject object = array.getJSONObject(i);
		    	 if(!object.get("links").equals(null))
		    	 {
		    		 System.out.println("i am here");
		    	  	 dataList.add(new StockItem(object.getString("Name"),object.getString("stock"),object.getString("mrp"),object.getString("mop"),object.getString("ksprice"),object.getString("tax"),object.getString("hsn"), object.getString("links")));
	...
	public  void send_http_request()
	{
		try {
			...
			String url ="http://khuranasales.co.in/work/get_products.php?brand=Samsung";
		     ...
		     {
		    	 JSONObject object = array.getJSONObject(i);
		    	 if(!object.get("link").equals(null))
		    	 {
		    	  	 dataList.add(new StockItem(object.getString("Name"),object.getString("stock"),object.getString("mrp"),object.getString("mop"),object.getString("ksprice"), object.getString("tax"),object.getString("hsn"),object.getString("link")));
