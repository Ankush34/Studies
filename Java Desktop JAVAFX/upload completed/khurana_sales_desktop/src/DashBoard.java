...
"    -fx-text-fill: WHITE;");
        ...
        VBox promoters_and_batches = Card("Promoters And Batches",15,"#A493C7"); 
        inner_grid.add(promoters_and_batches, 2, 0);
        inner_grid.setMargin(promoters_and_batches, new Insets(-90,0,80,0));
        VBox stock_and_orders = Card("Stock And Orders",14,"#F196F3");
        inner_grid.add(stock_and_orders, 2, 1);
        promoters_and_batches.setOnMouseClicked(value ->{
        	Promoters pro = new Promoters();
        	HBox view = pro.serve_scene();
        	view.setMinSize(1800, 1000);
        	scene = new Scene(view,1800,1000);
        	this.primary_stage_custom.centerOnScreen();
    ...
    public  HBox serve_scene()
    {
    	...
    	HBox pane = new HBox();
    	VBox sidePane = sidePane();
    	sidePane.setId("my_side_pane");
        pane.getChildren().add(sidePane);
...
"    -fx-text-fill: WHITE;");
        ...
        inner_grid.setVgap(15);
        inner_grid.setHgap(22);
        inner_grid.setId("my_inner_grid");
        ...
        inner_grid.add(card_manage_account, 1, 0);
        inner_grid.setMargin(card_manage_account, new Insets(-90,0,80,0));
        VBox operations = Card("Perform Operations",12,"#C51162");
        operations.setId("my_operations");
        inner_grid.add(operations, 0, 1);
        inner_grid.add(Card("Generate Notes",15,"#2196F3"), 1, 1);
        VBox promoters_and_batches = Card("Promoters And Batches",15,"#AA00FF"); 
        promoters_and_batches.setId("my_promoters_and_batches");
        inner_grid.add(promoters_and_batches, 2, 0);
        VBox stock_and_orders = Card("Stock And Orders",14,"#FF6D00");
        inner_grid.add(stock_and_orders, 2, 1);
        stock_and_orders.setId("my_stock_and_orders");
        inner_grid.setMargin(promoters_and_batches, new Insets(-90,0,80,0));
