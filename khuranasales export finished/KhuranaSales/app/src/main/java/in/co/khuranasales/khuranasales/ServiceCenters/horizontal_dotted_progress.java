...
public class horizontal_dotted_progress extends View {
        //actual dot radius
        ...
        public horizontal_dotted_progress(Context context) {
            super(context);
        }

        public horizontal_dotted_progress(Context context, AttributeSet attrs) {
            super(context, attrs);
        }

        public horizontal_dotted_progress(Context context, AttributeSet attrs, int defStyleAttr) {
