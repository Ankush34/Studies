...
public class search_product_discount_free_recycler_adapter extends RecyclerView.Adapter<search_product_discount_free_recycler_adapter.ViewHolder> {
    public ArrayList<Product> products;
    public recyclerViewItemClickListener item_click_listener;
    public search_product_discount_free_recycler_adapter(ArrayList<Product> products, recyclerViewItemClickListener item_click_listener)
    {
    ...
    @Override
    public search_product_discount_free_recycler_adapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        search_product_discount_free_recycler_adapter.ViewHolder viewHolder = new search_product_discount_free_recycler_adapter.ViewHolder(view,item_click_listener);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(search_product_discount_free_recycler_adapter.ViewHolder holder, int position) {
