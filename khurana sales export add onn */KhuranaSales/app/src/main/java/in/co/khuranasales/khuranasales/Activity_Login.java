...
public class Activity_Login extends AppCompatActivity {
    ...
    public void try_login()
    {
        ...
        Log.d("send url:- ", "" + url_login+"?email="+email+"&&password="+password);
        progress.setVisibility(View.VISIBLE);

        JsonArrayRequest arrayRequest = new JsonArrayRequest(url_login+"?email="+email+"&&password="+password, new Response.Listener<JSONArray>() {
            @Override
