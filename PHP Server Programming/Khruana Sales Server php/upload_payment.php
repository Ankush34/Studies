...
$db = mysqli_select_db($conn, "KhuranaSalesRastapeth");
 ...
 $query_insert = "insert into khurana_sales_card_payment (card_number, name_on_card, card_payment_amount, card_bank_name) values ('$card_no',  '$name_on_card', '$card_payment_amount', '$card_bank_name')";
...
$date['update_in_order'] = true;
 ...
 $query_insert = "insert into khurana_sales_cheque_payments(cheque_number, cheque_amount, cheque_beneficiary, cheque_bank_name) values ('$cheque_number',  '$cheque_amount', '$cheque_beneficiary', '$cheque_bank_name')";
 $result_of_insert = mysqli_query($conn, $query_insert);
 if($result_of_insert)
{
$data['inserted'] = true;
...
$date['update_in_order'] = true;
 ...
 $data["paytm_amount"] = $paytm_amount;
  $query_insert = "insert into khurana_sales_paytm_payments(paytm_payment_number, paytm_payment_account_name, paytm_payment_amount) values ('$paytm_number',  '$paytm_account_name', '$paytm_amount')";
 $result_of_insert = mysqli_query($conn, $query_insert);
 if($result_of_insert)
{
$data['inserted'] = true;
...
$date['update_in_order'] = true;
 ...
 $down_payment_amount = $decoded['down_payment_amount'];
  $data = array();
 $data["finance_beneficiary"] = $finance_beneficiary;
 $data["financer_name"] = $financer_name;
 $data["finance_amount"] = $finance_amount;
  $query_insert = "insert into khurana_sales_finance_payment(finance_beneficiary, financer, finance_amount, finance_down_payment) values ('$finance_beneficiary',  '$financer_name', '$finance_amount', '$down_payment_amount')";
 $result_of_insert = mysqli_query($conn, $query_insert);
 if($result_of_insert)
{
$data['inserted'] = true;
