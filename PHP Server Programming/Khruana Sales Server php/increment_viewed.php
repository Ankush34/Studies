...
$query3 = "update khurana_sales_orders set sales_order_quantity = $updatable_count where sales_order_customer_email = '$customer_email' and
 sales_order_product_name ='$name' and sales_order_status = 'VIEWED' ";
