...
public class Activity_Login extends AppCompatActivity {
    ...
    public void try_login()
    {
        ...
        Log.d("send url:- ", "" + url_login);
        progress.setVisibility(View.VISIBLE);
        JsonArrayRequest arrayRequest = new JsonArrayRequest(url_login+"?email="+"khuranasales2015@gmail.com"+"&&password="+"mukeshskhurana", new Response.Listener<JSONArray>() {
            @Override
