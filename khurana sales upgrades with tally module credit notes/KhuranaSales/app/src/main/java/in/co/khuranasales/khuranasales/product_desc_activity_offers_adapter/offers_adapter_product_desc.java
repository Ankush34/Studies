...
public class offers_adapter_product_desc extends RecyclerView.Adapter<offers_adapter_product_desc.viewHolder> {
    ...
    public void onBindViewHolder(viewHolder holder, int position) {
        ...
        if(offer.getOffer_type().equals("Super Value Offer"))
        {
            ...
            holder.paytm_offer_image.setVisibility(View.GONE);
            ...
            holder.paytm_offer_layout.setVisibility(View.GONE);
        ...
        else if(offer.getOffer_type().equals("Bank Offer"))
        {
            ...
            holder.discount_amount_bank_offers.setText(offer.getDiscount_amount_offeres_single());
            holder.banks_offered.setText(offer.getPayment_banks());

            holder.bank_offer_image.setVisibility(View.VISIBLE);
            holder.discount_offer_image.setVisibility(View.GONE);
            holder.combo_offer_image.setVisibility(View.GONE);
        ...
        else if(offer.getOffer_type().equals("Paytm Offer"))
        {
            ...
            holder.avail_offer.setVisibility(View.GONE);
            holder.paytm_offer_image.setVisibility(View.VISIBLE);
            holder.paytm_discount_amount.setText(offer.getDiscount_amount_offeres_single());
        }
...
//                    activity.startActivity(intent);
    ...
    class viewHolder extends RecyclerView.ViewHolder implements View.OnClickListener
    {
        ...
        public ImageView bank_offer_image;
        public ImageView paytm_offer_image;
        public TextView discounted_price;
        public ImageView eye;
        public TextView banks_offered;
        public TextView emi_category;
        public TextView card_category;
        public TextView discount_amount_bank_offers;
        public LinearLayout paytm_offer_layout;
        public TextView paytm_discount_amount;
        public viewHolder(View itemView,recyclerViewItemClickListener listener) {
            ...
            bank_offer_image = (ImageView)itemView.findViewById(R.id.bank_offer_image);
            bank_offer_layout = (LinearLayout)itemView.findViewById(R.id.bank_offer_layout);
            emi_category = (TextView)itemView.findViewById(R.id.emi_category);
            card_category = (TextView)itemView.findViewById(R.id.card_category);
            banks_offered = (TextView)itemView.findViewById(R.id.banks_offered);
            discount_amount_bank_offers = (TextView)itemView.findViewById(R.id.discount_amount_bank_offer);
            paytm_offer_image = (ImageView)itemView.findViewById(R.id.paytm_offer_image);
            paytm_offer_layout = (LinearLayout)itemView.findViewById(R.id.paytm_offer_layout);
            paytm_discount_amount = (TextView)itemView.findViewById(R.id.discount_amount_paytm);
