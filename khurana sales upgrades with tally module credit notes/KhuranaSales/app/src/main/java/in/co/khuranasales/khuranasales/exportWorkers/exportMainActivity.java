...
public class exportMainActivity extends AppCompatActivity {
    ...
    public RelativeLayout select_brands_export_accessory;
    public RelativeLayout select_brand_and_location_export_stock;
    ...
    public CardView card_export_accessory;
    public CardView card_export_location_wise;
    ...
    public ImageView down_arrow_select_brand_export_accessory;
    public ImageView down_arrow_select_location_and_brand_export_stock;
    ...
    public RecyclerView brands_select_export_accessory_recycler;
    public select_options_export_recycler_adapter brands_select_export_accessory_recycler_adapter;
    ...
    public RecyclerView brand_type_select_export_stock_location_wise_recycler;
    public RecyclerView location_type_select_export_stock_location_wise_recycler;
    public select_options_export_recycler_adapter brand_type_select_export_stock_location_wise_recycler_adapter;
    public select_options_export_recycler_adapter location_type_select_export_stock_location_wise_recycler_adapter;

    public ArrayList<selectionPojo> selection_list_promoters = new ArrayList<>();
    public ArrayList<selectionPojo> selection_list_brands_export_batch = new ArrayList<>();
    public ArrayList<selectionPojo> selection_list_brands_export_stock = new ArrayList<>();
    public ArrayList<selectionPojo> selection_list_payment_types = new ArrayList<>();
    public ArrayList<selectionPojo> selection_list_brands_export_accessory = new ArrayList<>();
    public ArrayList<selectionPojo> selection_list_brands_export_stock_location_wise = new ArrayList<>();
    public ArrayList<selectionPojo> selection_list_locations_export_stock_location_wise = new ArrayList<>();
    ...
    public Button brand_selected_export_accessory_button;
    public Button payment_export_button;
    public Button brand_and_location_selected_export_stock_location_wise_export_button;
    ...
    Button brand_select_button_export_accessory_share;
    Button brand_and_location_selected_export_stock_location_wise_export_share;
    ...
    public ImageView select_all_promoters_export;
    public ImageView select_all_brands_export_stock;
    public ImageView select_all_brands_export_batch;
    public ImageView select_all_payment_types_export;
    public ImageView select_all_brands_export_accessory;

    public boolean export_payment_types_all = false;
    public boolean export_promoter_all = false;
    public boolean export_stock_all = false;
    public boolean export_batch_all = false;
    public boolean export_all_accessory = false;

    public HashMap<String, ArrayList<Product>> products_with_location = new HashMap<>();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        select_all_payment_types_export = (ImageView)findViewById(R.id.select_all_export_payment);
        select_all_brands_export_batch = (ImageView)findViewById(R.id.select_all_brands_export_batch);
        select_all_brands_export_stock = (ImageView)findViewById(R.id.select_all_brand_export_stock);
        select_all_promoters_export = (ImageView)findViewById(R.id.select_all_export_promoters);
        select_all_brands_export_accessory = (ImageView)findViewById(R.id.select_all_brand_export_accessory);

        select_all_promoters_export.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(export_promoter_all == true)
                {
                    for(selectionPojo pojo : promoters_select_export_orders_recycler_adapter.selection_list)
                    {
                        pojo.set_selected(true);
                    }
                    promoters_select_export_orders_recycler_adapter.notifyDataSetChanged();
                    export_promoter_all = false;
                }
                else
                {
                    for(selectionPojo pojo : promoters_select_export_orders_recycler_adapter.selection_list)
                    {
                        pojo.set_selected(false);
                    }
                    promoters_select_export_orders_recycler_adapter.notifyDataSetChanged();
                    export_promoter_all = true;
                }
            }
        });

        select_all_brands_export_accessory.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(export_all_accessory == true)
                {
                    for(selectionPojo pojo : brands_select_export_accessory_recycler_adapter.selection_list)
                    {
                        pojo.set_selected(true);
                    }
                    brands_select_export_accessory_recycler_adapter.notifyDataSetChanged();
                    export_all_accessory = false;
                }
                else
                {
                    for(selectionPojo pojo : brands_select_export_accessory_recycler_adapter.selection_list)
                    ...
                    brands_select_export_accessory_recycler_adapter.notifyDataSetChanged();
                    export_all_accessory = true;
                }
            }
        });


        select_all_payment_types_export.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(export_payment_types_all == true)
                {
                    for(selectionPojo pojo : payment_type_select_export_batch_recycler_adapter.selection_list)
                    {
                        pojo.set_selected(true);
                    }
                    payment_type_select_export_batch_recycler_adapter.notifyDataSetChanged();
                    export_payment_types_all = false;
                }
                else
                {
                    for(selectionPojo pojo : payment_type_select_export_batch_recycler_adapter.selection_list)
                    ...
                    payment_type_select_export_batch_recycler_adapter.notifyDataSetChanged();
                    export_payment_types_all = true;
                }
            }
        });

        select_all_brands_export_stock.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(export_stock_all == true)
                {
                    for(selectionPojo pojo : brands_select_export_stock_recycler_adapter.selection_list)
                    {
                        pojo.set_selected(true);
                    }
                    brands_select_export_stock_recycler_adapter.notifyDataSetChanged();
                    export_stock_all = false;
                }
                else
                {
                    for(selectionPojo pojo : brands_select_export_stock_recycler_adapter.selection_list)
                    ...
                    brands_select_export_stock_recycler_adapter.notifyDataSetChanged();
                    export_stock_all = true;
                }
            }
        });

        select_all_brands_export_batch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(export_batch_all == true)
                {
                    for(selectionPojo pojo : brands_select_export_batch_recycler_adapter.selection_list)
                    {
                        pojo.set_selected(true);
                    }
                    brands_select_export_batch_recycler_adapter.notifyDataSetChanged();
                    export_batch_all = false;
                }
                else
                {
                    for(selectionPojo pojo : brands_select_export_batch_recycler_adapter.selection_list)
        ...
        brand_and_location_selected_export_stock_location_wise_export_button = (Button)findViewById(R.id.location_and_brand_selection_export_stock_button);
        brand_and_location_selected_export_stock_location_wise_export_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                check_permissions();
                new get_product_details_location_wise().execute();
                slideToBottom(select_brand_and_location_export_stock);
                fadeOut(background_transparent);
            }
        });
        ...
        brand_selected_export_accessory_button = (Button)findViewById(R.id.export_accessory_button);
        brand_selected_export_accessory_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                check_permissions();
                new get_accessory_details().execute();
                slideToBottom(select_brands_export_accessory);
                fadeOut(background_transparent);
            }
        });
        ...
        brand_and_location_selected_export_stock_location_wise_export_share = (Button)findViewById(R.id.location_and_brand_selection_export_stock_button_share);
        brand_and_location_selected_export_stock_location_wise_export_share.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                share = true;
                check_permissions();
        ...
        brand_select_button_export_accessory_share = (Button)findViewById(R.id.export_accessory_button_share);
        brand_select_button_export_accessory_share.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                share = true;
                check_permissions();
        ...
        down_arrow_select_brand_export_accessory = (ImageView)findViewById(R.id.down_arrow_brand_select_export_accessory);
        down_arrow_select_location_and_brand_export_stock = (ImageView)findViewById(R.id.down_arrow_brand_and_location_select_export_stock_location_wise);
        ...
        card_export_accessory = (CardView)findViewById(R.id.layout_export_accessory);
        card_export_location_wise = (CardView)findViewById(R.id.layout_export_location_wise);

        if(!appConfig.getUserType().equals("Admin"))
        {
            card_export_orders.setVisibility(View.GONE);
            card_export_accessory.setVisibility(View.GONE);
            card_export_batch.setVisibility(View.GONE);
            card_export_payments.setVisibility(View.GONE);
            card_export_stock.setVisibility(View.GONE);
        }
        ...
        select_brands_export_accessory = (RelativeLayout)findViewById(R.id.select_brand_list_export_accessory_layout);
        select_brand_and_location_export_stock = (RelativeLayout)findViewById(R.id.select_location_and_brand_list_export_stock_layout);


        brand_type_select_export_stock_location_wise_recycler = (RecyclerView)findViewById(R.id.recycler_brand_selection_export_location_wise_stock);
        location_type_select_export_stock_location_wise_recycler = (RecyclerView)findViewById(R.id.recycler_location_selection_export_location_wise_stock);
        brand_type_select_export_stock_location_wise_recycler_adapter = new select_options_export_recycler_adapter(this, selection_list_brands_export_stock_location_wise);
        location_type_select_export_stock_location_wise_recycler_adapter = new select_options_export_recycler_adapter(this, selection_list_locations_export_stock_location_wise);
        brand_type_select_export_stock_location_wise_recycler.setAdapter(brand_type_select_export_stock_location_wise_recycler_adapter);
        location_type_select_export_stock_location_wise_recycler.setAdapter(location_type_select_export_stock_location_wise_recycler_adapter);
        brand_type_select_export_stock_location_wise_recycler.setHasFixedSize(true);
        brand_type_select_export_stock_location_wise_recycler.setLayoutManager(new LinearLayoutManager(getApplicationContext()));
        location_type_select_export_stock_location_wise_recycler.setLayoutManager(new LinearLayoutManager(getApplicationContext()));
        location_type_select_export_stock_location_wise_recycler.setHasFixedSize(true);
        location_type_select_export_stock_location_wise_recycler_adapter.notifyDataSetChanged();
        brand_type_select_export_stock_location_wise_recycler_adapter.notifyDataSetChanged();
        ...
        brands_select_export_stock_recycler_adapter = new select_options_export_recycler_adapter(this, selection_list_brands_export_stock);
        ...
        brands_select_export_batch_recycler_adapter = new select_options_export_recycler_adapter(this, selection_list_brands_export_batch);
        ...
        brands_select_export_accessory_recycler = (RecyclerView)findViewById(R.id.recycler_brand_selection_export_accessory);
        brands_select_export_accessory_recycler.setLayoutManager(new LinearLayoutManager(getApplicationContext()));
        brands_select_export_accessory_recycler_adapter = new select_options_export_recycler_adapter(this, selection_list_brands_export_accessory);
        brands_select_export_accessory_recycler.setHasFixedSize(true);
        brands_select_export_accessory_recycler.setAdapter(brands_select_export_accessory_recycler_adapter);
        brands_select_export_accessory_recycler_adapter.notifyDataSetChanged();
        ...
        new load_batch_locations().execute();
        new load_brands_acccessory().execute();
        ...
        card_export_accessory.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                fadeIn(background_transparent);
                slideToTop(select_brands_export_accessory);
            }
        });
        card_export_location_wise.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                fadeIn(background_transparent);
                slideToTop(select_brand_and_location_export_stock);
            }
        });
        ...
        down_arrow_select_location_and_brand_export_stock.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                fadeOut(background_transparent);
                slideToBottom(select_brand_and_location_export_stock);
        ...
        down_arrow_select_brand_export_accessory.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                fadeOut(background_transparent);
                slideToBottom(select_brands_export_accessory);
    ...
    public class get_product_details_location_wise extends AsyncTask<Void, Void, Void>
    {
        @Override
        protected Void doInBackground(Void... voids) {
            product_details.clear();
            products_with_location.clear();
            JSONObject params_json = new JSONObject();
            JSONArray array = new JSONArray();
            JSONArray array_locations = new JSONArray();
            ArrayList<selectionPojo> selection_list = brands_select_export_stock_recycler_adapter.selection_list;
            for(int i = 0; i <selection_list_brands_export_stock_location_wise.size();i++)
            {
                if(selection_list_brands_export_stock_location_wise.get(i).is_selected()) {
                    try {
                        JSONObject object = new JSONObject();
                        Log.d("EXPORT",selection_list_brands_export_stock_location_wise.get(i).getSelection_text());
                        object.put("brand",selection_list_brands_export_stock_location_wise.get(i).getSelection_text());
            ...
            for(int i = 0; i <selection_list_locations_export_stock_location_wise.size();i++)
            {
                if(selection_list_locations_export_stock_location_wise.get(i).is_selected()) {
                    try {
                        JSONObject object = new JSONObject();
                        Log.d("EXPORT",selection_list_locations_export_stock_location_wise.get(i).getSelection_text());
                        object.put("location",selection_list_locations_export_stock_location_wise.get(i).getSelection_text());
                        array_locations.put(object);
                    } catch (JSONException e) {
                        e.printStackTrace();
                    }
                }
            ...
            try {
                ...
                params_json.put("locations",array_locations);
            } catch (JSONException e) {
                e.printStackTrace();
            }
            Log.d("PARAMS",params_json.toString());
            JsonObjectRequest get_promoters_data = new JsonObjectRequest(Request.Method.POST,AppConfig.get_product_export_with_batch_locations,params_json,
                        ...
                        public void onResponse(JSONObject response) {
                            try {
                                ...
                                if(response.getString("success").equals("true"))
                                {
                                    ...
                                    JSONObject response_products = response.getJSONObject("response");
                                    for(int i  = 0 ; i < selection_list_locations_export_stock_location_wise.size();i++)
                                    {
                                        String location = selection_list_locations_export_stock_location_wise.get(i).getSelection_text();
                                        if(selection_list_locations_export_stock_location_wise.get(i).is_selected())
                                        {
                                            JSONArray products_at_that_location = response_products.getJSONArray(location);
                                            for(int j  = 0 ; j < products_at_that_location.length();j++)
                                            {
                                                JSONObject obj = products_at_that_location.getJSONObject(j);
                                                if(products_with_location.get(location) == null)
                                                {
                                                    ...
                                                    products_with_location.put(location,products);
                                                    Log.d("EXPORTACTIVITY","Adding New");
                                                }
                                                else
                                                {
                                                    Product product = new Product();
                                                    ...
                                                    product.setProduct_HSN(obj.getString("hsn"));
                                                    product.setTax(obj.getInt("tax"));
                                                    products_with_location.get(location).add(product);
                                                    Log.d("EXPORTACTIVITY","Inserting Again");
                                                }
                                            }
                                        }
                                    }
                                    generate_export_location_wise();
                                }
                                else {
    ...
    public void generate_export_location_wise()
    {
        String state = Environment.getExternalStorageState();
        String root = "";
        String fileName = "/location_wise_stock_export" + System.currentTimeMillis() + ".pdf";
        ...
        try {
            ...
            table.addCell(getCell("Khurana Sales Location Wise Stock Export",PdfPCell.ALIGN_CENTER));
            table.addCell(getCell("Email: khuranasales2015@gmail.com",PdfPCell.ALIGN_RIGHT));
            table.setWidthPercentage(100);
            table.setSpacingAfter(20);
            document.add(table);

            for(String key: products_with_location.keySet())
            {
                ArrayList<Product> products = products_with_location.get(key);

                PdfPTable table_description_location = new PdfPTable(1);
                table_description_location.addCell(getCell(""+key,PdfPCell.ALIGN_CENTER));
                table_description_location.setWidthPercentage(100);
                table_description_location.setSpacingAfter(20);
                table_description_location.setSpacingBefore(20);
                document.add(table_description_location);
                PdfPTable table_products = null;
                if(appConfig.getUserType().equals("Admin"))
                {
                    table_products = new PdfPTable(4);
                    Font tableFont = FontFactory.getFont(FontFactory.HELVETICA,10,Font.NORMAL);
                    table_products.setWidths(new int[]{3, 1, 1, 1});
                    table_products.addCell(new Paragraph("Product Name",tableFont));
                    table_products.addCell(new Paragraph("Product KS-Price",tableFont));
                    table_products.addCell(new Paragraph("Product MOP",tableFont));
                    table_products.addCell(new Paragraph("Stock",tableFont));
                    table_products.setHeaderRows(1);

                    for(int i = 0 ;i < products.size();i++)
                    {
                        table_products.addCell(new Paragraph(products.get(i).get_Name(),tableFont));
                        PdfPCell cell = new PdfPCell(new Paragraph(""+products.get(i).getPrice_ks(),tableFont));
                        cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                        cell.setBackgroundColor(BaseColor.YELLOW);
                        table_products.addCell(cell);
                        table_products.addCell(new Paragraph(""+products.get(i).getPrice_mop(),tableFont));
                        table_products.addCell(new Paragraph(""+products.get(i).get_Stock(),tableFont));
                    }
                }
                else
                {
                    Font tableFont = FontFactory.getFont(FontFactory.HELVETICA,10,Font.NORMAL);
                    table_products = new PdfPTable(2);
                    table_products.setWidths(new int[]{3, 1});
                    table_products.addCell(new Paragraph("Product Name",tableFont));
                    table_products.addCell(new Paragraph("Stock",tableFont));
                    table_products.setHeaderRows(1);
                ...
                table_products.setWidthPercentage(100);
    ...
    public class load_brands_acccessory extends AsyncTask<Void, Void, Void>
    {
        @Override
        protected Void doInBackground(Void... voids) {
            JsonArrayRequest request_brands = new JsonArrayRequest(AppConfig.url_categories+"?category=Accessory", new Response.Listener<JSONArray>() {
                @Override
                public void onResponse(JSONArray response) {
                    for(int i =0 ; i < response.length();i++)
                    {
                        try {
                            ...
                            selection_list_brands_export_accessory.add(p);
                            brands_select_export_accessory_recycler_adapter.notifyDataSetChanged();
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                ...
                public void onResponse(JSONArray response) {
                    for(int i =0 ; i < response.length();i++)
                    {
                        try {
                            JSONObject obj = response.getJSONObject(i);
                            selectionPojo p = new selectionPojo(obj.getString("brand"),false);
                            selection_list_brands_export_stock.add(p);
                            selection_list_brands_export_batch.add(p);
                            selection_list_brands_export_stock_location_wise.add(p);
                            brands_select_export_batch_recycler_adapter.notifyDataSetChanged();
                            brands_select_export_stock_recycler_adapter.notifyDataSetChanged();
                            brand_type_select_export_stock_location_wise_recycler_adapter.notifyDataSetChanged();
                        } catch (Exception e) {
    ...
    public class get_accessory_details extends AsyncTask<Void, Void, Void>
    {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            JSONObject params_json = new JSONObject();
            JSONArray array = new JSONArray();
            ArrayList<selectionPojo> selection_list = brands_select_export_accessory_recycler_adapter.selection_list;
            for(int i = 0; i <selection_list.size();i++)
            {
                if(selection_list.get(i).is_selected()) {
                    try {
   ...
   public void generateStockExport(ArrayList<Product> product_details)
   {
       ...
       try {
           ...
           Font tableFont = FontFactory.getFont(FontFactory.HELVETICA,10,Font.NORMAL);
           PdfPTable table_promoter = new PdfPTable(4);
           table_promoter.setWidths(new int[]{3, 1, 1, 1});
           table_promoter.addCell(new Paragraph("Product Name",tableFont));
           ...
           for(int i = 0 ;i < product_details.size();i++)
           {
               ...
               PdfPCell cell = new PdfPCell(new Paragraph(""+product_details.get(i).getPrice_ks(),tableFont));
               cell.setHorizontalAlignment(Element.ALIGN_CENTER);
               cell.setBackgroundColor(BaseColor.YELLOW);
               table_promoter.addCell(cell);
   ...
   public class load_batch_locations extends AsyncTask<Void, Void, Void>
   {
       @Override
       protected Void doInBackground(Void... voids) {
               ...
               public void onResponse(JSONArray response) {
                    for(int i = 0; i < response.length();i++)
                    {
                        try{
                            ...
                            selectionPojo p = new selectionPojo(location.getString("Column"),false);
                            selection_list_locations_export_stock_location_wise.add(p);
                            location_type_select_export_stock_location_wise_recycler_adapter.notifyDataSetChanged();
                        }catch (Exception e)
                        {
