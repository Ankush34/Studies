...
public class Product implements Parcelable
{
    ...
    private int offer_id_for_deletion_copied_offer_product;
    private int total_offers_count;
    ...
    public int getTotal_offers_count() {
        return total_offers_count;
    }

    public void setTotal_offers_count(int total_offers_count) {
        this.total_offers_count = total_offers_count;
    }

    public int getOffer_id_for_deletion_copied_offer_product() {
        return offer_id_for_deletion_copied_offer_product;
    }

    public void setOffer_id_for_deletion_copied_offer_product(int offer_id_for_deletion_copied_offer_product) {
        this.offer_id_for_deletion_copied_offer_product = offer_id_for_deletion_copied_offer_product;
    }
