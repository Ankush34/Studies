...
import static in.co.khuranasales.khuranasales.Utils.pxToDp;
public class MaterialViewPagerSettings implements Parcelable {
    ...
    protected void handleAttributes(Context context, AttributeSet attrs){
        try {
            ...
            {
                headerHeightPx = styledAttrs.getDimensionPixelOffset(R.styleable.MaterialViewPager_viewpager_headerHeight, 100);
