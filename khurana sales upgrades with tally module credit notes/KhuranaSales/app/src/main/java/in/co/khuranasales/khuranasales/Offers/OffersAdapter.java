...
public class OffersAdapter extends RecyclerView.Adapter<OffersAdapter.viewHolder> {
        ...
        public recyclerViewItemClickListener copy_offer_listener;

        public OffersAdapter(ArrayList<Offer> offers_sent, Activity activity,recyclerViewItemClickListener listener, recyclerViewItemClickListener edit_listener, recyclerViewItemClickListener copy_offer_listener)
        {
            ...
            this.copy_offer_listener = copy_offer_listener;
        }
    ...
    public void onBindViewHolder(viewHolder holder, int position) {
            ...
            if(offer.isExpired())
            {
               ...
               holder.avail_offer.setOnClickListener(new View.OnClickListener() {
                   ...
                   public void onClick(View v) {
                       Toast.makeText(activity,"Sorry this offer is expired",Toast.LENGTH_LONG).show();
                   }
               });
            }
            else
            ...
            if(offer.getOffer_type().equals("Super Value Offer"))
            {
                ...
                holder.discount_offer_layout.setVisibility(View.GONE);
                holder.bank_offer_layout.setVisibility(View.GONE);
            ...
            else if(offer.getOffer_type().equals("Discount Offer"))
            {
                ...
                holder.super_value_offer_layout.setVisibility(View.GONE);
                holder.bank_offer_layout.setVisibility(View.GONE);
                holder.eye.setVisibility(View.INVISIBLE);
            ...
            {
                holder.eye.setVisibility(View.INVISIBLE);
                holder.avail_offer.setVisibility(View.GONE);
                holder.discount_offer_layout.setVisibility(View.GONE);
                holder.super_value_offer_layout.setVisibility(View.GONE);
                holder.bank_offer_layout.setVisibility(View.VISIBLE);
                holder.emi_category.setText(offer.getEmi_category());
                holder.card_category.setText(offer.getCard_category());
                holder.payment_banks.setText(offer.getPayment_banks().replaceAll(",","\n\n"));
                holder.discount_amount_bank_offer.setText(offer.getDiscount_amount_offeres_single());
            }
            else if(offer.getOffer_type().equals("Paytm Offer"))
            {
                ...
                holder.discount_offer_layout.setVisibility(View.GONE);
                holder.super_value_offer_layout.setVisibility(View.GONE);
                holder.paytm_offer_layout.setVisibility(View.VISIBLE);
                holder.discount_amount_paytm.setText(offer.getDiscount_amount_offeres_single());
                holder.eye.setVisibility(View.INVISIBLE);
            }
            ...
            // requirement is to show dealer price rather than the ks price so switching to the ks price
            holder.ksprice.setText(offer.getOffer_product_mop_price());
    ...
    class viewHolder extends RecyclerView.ViewHolder implements View.OnClickListener
{
    ...
    public TextView emi_category;
    public TextView payment_banks;
    public TextView card_category;
    public LinearLayout bank_offer_layout;
    public TextView discount_amount_bank_offer;
    public LinearLayout paytm_offer_layout;
    public TextView discount_amount_paytm;
    public ImageView copy_offer;
    ...
    public viewHolder(View itemView,recyclerViewItemClickListener listener) {
        ...
        emi_category = (TextView)itemView.findViewById(R.id.emi_category_bank_offer);
        card_category = (TextView)itemView.findViewById(R.id.card_category_bank_offer);
        payment_banks = (TextView)itemView.findViewById(R.id.payment_banks);
        bank_offer_layout = (LinearLayout)itemView.findViewById(R.id.bank_offer_layout);
        discount_amount_bank_offer = (TextView)itemView.findViewById(R.id.discount_amount_bank_offer);
        paytm_offer_layout = (LinearLayout)itemView.findViewById(R.id.paytm_offer_layout);
        discount_amount_paytm = (TextView)itemView.findViewById(R.id.discount_amount_paytm);
        copy_offer = (ImageView)itemView.findViewById(R.id.copy_offer);
        copy_offer.setOnClickListener(this);
        if(!appConfig.getUserType().equals("Admin"))
        {
    ...
    public void onClick(View v) {
        ...
        else if(v.getId() == R.id.copy_offer)
        {
            copy_offer_listener.onItemClick(v, getAdapterPosition());
        }
        else
        {
