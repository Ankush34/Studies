...
public class TestRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        switch (getItemViewType(position)) {
            ...
            case TYPE_CELL:
               final ViewHolder1 holder1 =(ViewHolder1) holder;
                ...
                if(p.has_offers())
                {
                    holder1.offers_available.setVisibility(View.VISIBLE);
                    holder1.offers_available.setOnClickListener(new View.OnClickListener() {
                        @Override
                    ...
                    holder1.offers_available.setVisibility(View.GONE);
                    holder1.offers_available.setOnClickListener(null);
                }
                ...
                if(holder1.appConfig.getUserType().equals("Shop Admin"))
                {
                    holder1.ks_price_image.setVisibility(View.VISIBLE);
                    holder1.ks_price_title.setVisibility(View.VISIBLE);
                    holder1.view3.setVisibility(View.VISIBLE);
                }
                if(p.isFavorite())
                {
    ...
    class ViewHolder1 extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public ImageView offers_available;
        ...
        public ViewHolder1(final View itemView, int a, recyclerViewItemClickListener listener) {
            ...
            offers_available = (ImageView)itemView.findViewById(R.id.offers_available);
            mlistener = listener;
...
public class add_to_favorites extends AsyncTask<Product, Void, Void>
{
    ...
    protected Void doInBackground(Product... products) {
        JsonArrayRequest add_to_favorites_request = new JsonArrayRequest(AppConfig.add_to_favorites+products[0].getProduct_id()+"&email="+appConfig.getUser_email().trim(), new Response.Listener<JSONArray>() {
            @Override
        ...
        add_to_favorites_request.setRetryPolicy(new DefaultRetryPolicy(
                DefaultRetryPolicy.DEFAULT_TIMEOUT_MS,
                DefaultRetryPolicy.DEFAULT_MAX_RETRIES,
                DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
    ...
    public class remove_from_favorites extends AsyncTask<Product, Void, Void>
    {
        ...
        @Override
        protected Void doInBackground(Product... products) {
            JsonArrayRequest remove_from_favorites_request = new JsonArrayRequest(AppConfig.remove_from_favorites+products[0].getProduct_id()+"&email="+appConfig.getUser_email().trim(), new Response.Listener<JSONArray>() {
                @Override
                public void onResponse(JSONArray response)
                {
                    try {
            ...
            remove_from_favorites_request.setRetryPolicy(new DefaultRetryPolicy(
                    DefaultRetryPolicy.DEFAULT_TIMEOUT_MS,
                    DefaultRetryPolicy.DEFAULT_MAX_RETRIES,
                    DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
