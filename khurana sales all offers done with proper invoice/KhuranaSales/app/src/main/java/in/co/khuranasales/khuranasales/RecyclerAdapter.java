...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        if(appConfig.getUserType().equals("Admin") || appConfig.getUserType().equals("Dealer") || appConfig.getUserType().equals("Shop Admin"))
        {
   ...
   {
       String url = AppConfig.url_delete_viewed+"customer_email="+appConfig.getUser_email().trim()+"&product_id="+m.getProduct_id();
       Log.d("URL:",url);
   ...
   public void change_count_product_online(Product product,String operation){
        ...
        Log.d("url",""+url);
        JsonArrayRequest decrementRequest = new JsonArrayRequest(url+"product_id="+product.getProduct_id()+"&customer_email="+appConfig.getUser_email().trim(), new Response.Listener<JSONArray>() {
            @Override
            public void onResponse(JSONArray response) {
               try {
