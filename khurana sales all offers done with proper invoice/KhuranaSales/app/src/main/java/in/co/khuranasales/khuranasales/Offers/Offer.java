...
public class Offer {
    ...
    public String emi_category;
    public String card_category;
    public String payment_banks;

    public String getEmi_category() {
        return emi_category;
    }

    public void setEmi_category(String emi_category) {
        this.emi_category = emi_category;
    }
    ...
    public String getPayment_banks() {
        return payment_banks;
    }

    public void setPayment_banks(String payment_banks) {
        this.payment_banks = payment_banks;
    }
