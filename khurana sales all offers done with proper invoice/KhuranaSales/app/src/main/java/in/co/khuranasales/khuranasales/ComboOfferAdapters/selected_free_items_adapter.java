...
public class selected_free_items_adapter extends RecyclerView.Adapter<selected_free_items_adapter.ViewHolder> {
    public ArrayList<Product> products;
    public recyclerViewItemClickListener item_click_listener;
    public selected_free_items_adapter(ArrayList<Product> products, recyclerViewItemClickListener item_click_listener)
    {
    ...
    @Override
    public selected_free_items_adapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        selected_free_items_adapter.ViewHolder viewHolder = new selected_free_items_adapter.ViewHolder(view,item_click_listener);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(selected_free_items_adapter.ViewHolder holder, int position) {
