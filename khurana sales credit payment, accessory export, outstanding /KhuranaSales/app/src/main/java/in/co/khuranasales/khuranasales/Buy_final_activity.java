...
public class Buy_final_activity extends AppCompatActivity {
    ...
    public void set_baught() {
        ...
        Log.d("URL: ", "" + AppConfig.set_bought_with_update_batch_locations + appConfig.getUser_email());
        JsonArrayRequest bought_req = new JsonArrayRequest((AppConfig.set_bought_with_update_batch_locations + appConfig.getUser_email()+"&discount="+getIntent().getExtras().getInt("discount_applicable") +"&date="+formattedDate),
