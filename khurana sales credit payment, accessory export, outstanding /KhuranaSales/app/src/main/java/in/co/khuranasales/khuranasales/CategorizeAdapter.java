        ...
        public ViewHolder(final View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(sub_categories.get(position).name.equals("Mobile Chargers"))
                    {
                        Intent intent = new Intent(activity.getApplicationContext(),Product_view_activity.class);
                        intent.putExtra("Filter","Charger");
                        activity.overridePendingTransition(0,R.anim.slide_out_left_animation);
                        activity.startActivity(intent);

                    }

                    if(sub_categories.get(position).name.equals("Mobile Earphones"))
                    {
                        Intent intent = new Intent(activity.getApplicationContext(),Product_view_activity.class);
                        intent.putExtra("Filter","Headphone");
                        activity.overridePendingTransition(0,R.anim.slide_out_left_animation);
                        activity.startActivity(intent);

                    }

                    if(sub_categories.get(position).name.equals("Phone Covers"))
                    {
                        Intent intent = new Intent(activity.getApplicationContext(),Product_view_activity.class);
                        intent.putExtra("Filter","Cover");
                        activity.overridePendingTransition(0,R.anim.slide_out_left_animation);
                        activity.startActivity(intent);

                    }

                    if(sub_categories.get(position).name.equals("DataCable"))
                    {
                        Intent intent = new Intent(activity.getApplicationContext(),Product_view_activity.class);
                        intent.putExtra("Filter","Cable");
                        activity.overridePendingTransition(0,R.anim.slide_out_left_animation);
                        activity.startActivity(intent);

                    }

                    if(sub_categories.get(position).name.equals("Mobile Bluetooth"))
                    {
                        Intent intent = new Intent(activity.getApplicationContext(),Product_view_activity.class);
                        intent.putExtra("Filter","Bluetooth");
                        activity.overridePendingTransition(0,R.anim.slide_out_left_animation);
                        activity.startActivity(intent);
                    }

                    if(sub_categories.get(position).name.equals("PowerBank"))
                    {
                        Intent intent = new Intent(activity.getApplicationContext(),Product_view_activity.class);
                        intent.putExtra("Filter","Power");
                        activity.overridePendingTransition(0,R.anim.slide_out_left_animation);
                        activity.startActivity(intent);

                    }

                    if(sub_categories.get(position).name.equals("ScreenGuard"))
                    {
                        Intent intent = new Intent(activity.getApplicationContext(),Product_view_activity.class);
                        intent.putExtra("Filter","Screen");
                        activity.overridePendingTransition(0,R.anim.slide_out_left_animation);
                        activity.startActivity(intent);

                    }

                    if(sub_categories.get(position).name.equals("Speakers"))
                    {
                        Intent intent = new Intent(activity.getApplicationContext(),Product_view_activity.class);
                        intent.putExtra("Filter","Speaker");
                        activity.overridePendingTransition(0,R.anim.slide_out_left_animation);
                        activity.startActivity(intent);
